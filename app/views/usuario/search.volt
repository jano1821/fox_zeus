                        ...
                        {% if page.items is defined %}
                            {% for usuario in page.items %}
                                <tr>
                                    ...
                                    <td>{{ link_to("usuario/edit/"~usuario.codUsuario, "class":"btn btn-default","<i class='glyphicon glyphicon-edit'></i>") }}</td>
                                    <td>{{ link_to("usuario/delete/"~usuario.codUsuario, "class":"btn btn-default","<i class='glyphicon glyphicon-trash'></i>") }}</td>

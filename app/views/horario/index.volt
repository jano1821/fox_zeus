<div class="page-header">
    ...
    <p>
        {{ link_to("horario/new", "Create horario") }}
    </p>
</div>

{{ content() }}

{{ form("horario/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}

<div class="form-group">
    <label for="fieldCodhorario" class="col-sm-2 control-label">CodHorario</label>
    <div class="col-sm-10">
        {{ text_field("codHorario", "type" : "numeric", "class" : "form-control", "id" : "fieldCodhorario") }}
    </div>
</div>

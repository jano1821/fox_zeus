<div class="page-header">
    ...
    <p>
        {{ link_to("precio/new", "Create precio") }}
    </p>
</div>

{{ content() }}

{{ form("precio/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}

<div class="form-group">
    <label for="fieldCodprecio" class="col-sm-2 control-label">CodPrecio</label>
    <div class="col-sm-10">
        {{ text_field("codPrecio", "type" : "numeric", "class" : "form-control", "id" : "fieldCodprecio") }}
    </div>
</div>
...
<div class="form-group">
    <label for="fieldMonto" class="col-sm-2 control-label">Monto</label>
    <div class="col-sm-10">
        {{ text_field("monto", "type" : "numeric", "class" : "form-control", "id" : "fieldMonto") }}
    </div>
</div>

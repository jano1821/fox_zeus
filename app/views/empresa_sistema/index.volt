        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="btn-group pull-right">
                    ...
                    {{ link_to("empresa", "<i class='glyphicon glyphicon-chevron-left'></i> Volver a Busqueda de Empresa","class":"btn btn-info") }}
                    {{ link_to("empresa_sistema/new/"~codigoEmpresa, "<i class='glyphicon glyphicon-plus'></i> Nuevo Vinculo","class":"btn btn-info") }}
                </div>
            ...
            {{ form("empresa_sistema/search/"~codigoEmpresa, "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
            <div class="table">

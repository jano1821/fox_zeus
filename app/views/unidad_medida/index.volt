<div class="page-header">
    ...
    <p>
        {{ link_to("unidad_medida/new", "Create unidad_medida") }}
    </p>
</div>

{{ content() }}

{{ form("unidad_medida/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}

<div class="form-group">
    <label for="fieldCodunidad" class="col-sm-2 control-label">CodUnidad</label>
    <div class="col-sm-10">
        {{ text_field("codUnidad", "type" : "numeric", "class" : "form-control", "id" : "fieldCodunidad") }}
    </div>
</div>

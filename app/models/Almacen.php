...
class Almacen extends \Phalcon\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->setSource("almacen");
        $this->hasMany('codAlmacen', 'HistoricoMovimientos', 'codAlmacen', ['alias' => 'HistoricoMovimientos']);
        $this->hasMany('codAlmacen', 'Logistica', 'codAlmacen', ['alias' => 'Logistica']);
        $this->hasMany('codAlmacen', 'Ubicacion', 'codAlmacen', ['alias' => 'Ubicacion']);
    }
     ...
     * @return Almacen[]|Almacen|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return Almacen|\Phalcon\Mvc\Model\ResultInterface
     */

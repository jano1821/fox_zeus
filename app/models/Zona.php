...
class Zona extends \Phalcon\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->setSource("zona");
        $this->hasMany('codZona', 'Ubicacion', 'codZona', ['alias' => 'Ubicacion']);
    }
     ...
     * @return Zona[]|Zona|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return Zona|\Phalcon\Mvc\Model\ResultInterface
     */

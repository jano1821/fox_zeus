...
class Precio extends \Phalcon\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->setSource("precio");
        $this->hasMany('codPrecio', 'ProductoPrecio', 'codPrecio', ['alias' => 'ProductoPrecio']);
    }
     ...
     * @return Precio[]|Precio|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return Precio|\Phalcon\Mvc\Model\ResultInterface
     */

...
class Sector extends \Phalcon\Mvc\Model
{
    ...
    public function initialize()
    {
        ...
        $this->setSource("sector");
        $this->hasMany('codSector', 'Ubicacion', 'codSector', ['alias' => 'Ubicacion']);
    }
     ...
     * @return Sector[]|Sector|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return Sector|\Phalcon\Mvc\Model\ResultInterface
     */

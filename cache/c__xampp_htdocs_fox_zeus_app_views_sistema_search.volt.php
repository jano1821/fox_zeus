                        ...
                        <?php if (isset($page->items)) { ?>
                            <?php foreach ($page->items as $sistema) { ?>
                                <tr>
                                    ...
                                    <td><?= $this->tag->linkTo(['sistema/edit/' . $sistema->codSistema, 'class' => 'btn btn-default', '<i class=\'glyphicon glyphicon-edit\'></i>']) ?></td>
                                    <td><?= $this->tag->linkTo(['sistema/delete/' . $sistema->codSistema, 'class' => 'btn btn-default', '<i class=\'glyphicon glyphicon-trash\'></i>']) ?></td>
                                </tr>
                            <?php } ?>
                        <?php } ?>
                    </tbody>

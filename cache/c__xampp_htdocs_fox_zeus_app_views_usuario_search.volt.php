                        ...
                        <?php if (isset($page->items)) { ?>
                            <?php foreach ($page->items as $usuario) { ?>
                                <tr>
                                    ...
                                    <td><?= $this->tag->linkTo(['usuario/edit/' . $usuario->codUsuario, 'class' => 'btn btn-default', '<i class=\'glyphicon glyphicon-edit\'></i>']) ?></td>
                                    <td><?= $this->tag->linkTo(['usuario/delete/' . $usuario->codUsuario, 'class' => 'btn btn-default', '<i class=\'glyphicon glyphicon-trash\'></i>']) ?></td>

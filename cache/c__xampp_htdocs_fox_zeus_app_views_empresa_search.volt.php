                        ...
                        <?php if (isset($page->items)) { ?>
                            <?php foreach ($page->items as $empresa) { ?>
                                <tr>
                                    ...
                                    <td><?= $this->tag->linkTo(['empresa/edit/' . $empresa->codEmpresa, 'class' => 'btn btn-default', '<i class=\'glyphicon glyphicon-edit\'></i>']) ?></td>
                                    <td><?= $this->tag->linkTo(['empresa/delete/' . $empresa->codEmpresa, 'class' => 'btn btn-default', '<i class=\'glyphicon glyphicon-trash\'></i>']) ?></td>
                                </tr>
                            <?php } ?>
                        <?php } ?>
                    </tbody>

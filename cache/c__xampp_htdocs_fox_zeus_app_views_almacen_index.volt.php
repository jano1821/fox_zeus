<div class="page-header">
    ...
    <p>
        <?= $this->tag->linkTo(['almacen/new', 'Create almacen']) ?>
    </p>
</div>

<?= $this->getContent() ?>

<?= $this->tag->form(['almacen/search', 'method' => 'post', 'autocomplete' => 'off', 'class' => 'form-horizontal']) ?>

<div class="form-group">
    <label for="fieldCodalmacen" class="col-sm-2 control-label">CodAlmacen</label>
    <div class="col-sm-10">
        <?= $this->tag->textField(['codAlmacen', 'type' => 'numeric', 'class' => 'form-control', 'id' => 'fieldCodalmacen']) ?>
    </div>
</div>
